...
class HelpDeskDashboardController extends Controller
{
    ...
    {
        abort_unless(auth()->user()?->isHelpDesk(), 403);
        ...
        $summary = [
            ...
            'fixed_deposit' => (int) ($accountBalances[Account::TYPE_FIXED_DEPOSIT] ?? 0),
            'income' => $income,
        ...
        return view('help-desk.dashboard', compact('summary', 'financialYear'));
    }
