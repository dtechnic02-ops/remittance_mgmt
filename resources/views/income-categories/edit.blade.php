                ...
                <form method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   id="code"
                                   name="code"
                                   value="{{ old('code', $incomeCategory->code) }}"
                                   maxlength="50"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="description"
                                  name="description"
                                  rows="4"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('description', $incomeCategory->description) }}</textarea>
                    ...
                    <div class="mt-6">
                        <label class="inline-flex items-center">
                            ...
                            <input type="checkbox"
                                   name="is_active"
                                   value="1"
                                   @checked(old('is_active', $incomeCategory->is_active))
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Uncheck this to stop using this category for new income entries.
                        </p>
                    </div>
