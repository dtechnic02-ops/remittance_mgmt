                ...
                <form method="POST"
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="english_date" name="english_date" value="{{ old('english_date') }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" id="nepali_date" name="nepali_date" value="{{ old('nepali_date') }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="account" name="account" value="{{ old('account') }}" maxlength="100"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" id="branch" name="branch" value="{{ old('branch') }}" maxlength="150"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
